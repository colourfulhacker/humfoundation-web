...
const LMS_MODULES: CourseModule[] = [
  {
    ...
    materials: [
      ...
      },
      {
        ...
        content: 'Entrepreneurship is not just about starting a business; it is about solving problems. Successful entrepreneurs identify gaps in the market and create value. Key traits include resilience, adaptability, and vision. Develop a growth mindset by: viewing failures as learning opportunities, seeking feedback constantly, staying curious about customer needs, and continuously improving your skills.',
        contentHi: 'उद्यमिता केवल व्यवसाय शुरू करने के बारे में नहीं है; यह समस्याओं को हल करने के बारे में है। सफल उद्यमी बाजार में अंतराल की पहचान करते हैं और मूल्य बनाते हैं। मुख्य लक्षणों में लचीलापन, अनुकूलनशीलता और दृष्टि शामिल हैं। विकास मानसिकता विकसित करें: असफलताओं को सीखने के अवसर के रूप में देखें, लगातार प्रतिक्रिया मांगें, ग्राहक की जरूरतों के बारे में जिज्ञासु रहें, और लगातार अपने कौशल में सुधार करें।',
        contentBn: 'উদ্যোক্তা শুধুমাত্র ব্যবসা শুরু করার বিষয়ে নয়; এটি সমস্যা সমাধানের বিষয়ে। সফল উদ্যোক্তারা বাজারে ফাঁক চিহ্নিত করেন এবং মূল্য তৈরি করেন। মূল বৈশিষ্ট্যগুলির মধ্যে রয়েছে স্থিতিস্থাপকতা, অভিযোজনযোগ্যতা এবং দৃষ্টি। বৃদ্ধি মানসিকতা বিকাশ করুন: ব্যর্থতাগুলিকে শেখার সুযোগ হিসাবে দেখুন, ক্রমাগত প্রতিক্রিয়া সন্ধান করুন, গ্রাহকের চাহিদা সম্পর্কে কৌতূহলী থাকুন এবং ক্রমাগত আপনার দক্ষতা উন্নত করুন।'
      },
      {
        type: 'text',
        title: 'Lesson 3: Legal Structures in India',
        content: 'Choosing the right business structure is crucial. In India, common options include: (1) Sole Proprietorship - simplest form, owned by one person, easy to start but unlimited liability, (2) Partnership - 2+ people share profits and responsibilities, (3) Private Limited Company (Pvt Ltd) - separate legal entity, limited liability, requires minimum 2 directors, (4) Limited Liability Partnership (LLP) - hybrid structure combining benefits of partnership and company. Consider factors like liability protection, tax implications, compliance requirements, and funding needs when choosing.',
        contentHi: 'सही व्यावसायिक संरचना चुनना महत्वपूर्ण है। भारत में, सामान्य विकल्पों में शामिल हैं: (1) एकल स्वामित्व - सबसे सरल रूप, एक व्यक्ति के स्वामित्व में, शुरू करना आसान लेकिन असीमित देयता, (2) साझेदारी - 2+ लोग लाभ और जिम्मेदारियां साझा करते हैं, (3) प्राइवेट लिमिटेड कंपनी (Pvt Ltd) - अलग कानूनी इकाई, सीमित देयता, न्यूनतम 2 निदेशकों की आवश्यकता, (4) लिमिटेड लायबिलिटी पार्टनरशिप (LLP) - साझेदारी और कंपनी के लाभों को मिलाने वाली हाइब्रिड संरचना। चुनते समय देयता सुरक्षा, कर निहितार्थ, अनुपालन आवश्यकताओं और फंडिंग जरूरतों जैसे कारकों पर विचार करें।',
        contentBn: 'সঠিক ব্যবসায়িক কাঠামো নির্বাচন করা গুরুত্বপূর্ণ। ভারতে, সাধারণ বিকল্পগুলির মধ্যে রয়েছে: (1) একক মালিকানা - সহজতম ফর্ম, একজনের মালিকানাধীন, শুরু করা সহজ কিন্তু সীমাহীন দায়, (2) অংশীদারিত্ব - 2+ জন লাভ এবং দায়িত্ব ভাগ করে নেয়, (3) প্রাইভেট লিমিটেড কোম্পানি (Pvt Ltd) - পৃথক আইনি সত্তা, সীমিত দায়, ন্যূনতম 2 পরিচালক প্রয়োজন, (4) লিমিটেড লায়াবিলিটি পার্টনারশিপ (LLP) - অংশীদারিত্ব এবং কোম্পানির সুবিধা একত্রিত করে হাইব্রিড কাঠামো। নির্বাচন করার সময় দায় সুরক্ষা, কর প্রভাব, সম্মতি প্রয়োজনীয়তা এবং তহবিল প্রয়োজনের মতো বিষয়গুলি বিবেচনা করুন।'
      },

...
const LMS_MODULES: CourseModule[] = [
  { 
    ...
    level: 'Beginner',
    materials: [
      { type: 'video', title: 'Welcome to Entrepreneurship', url: 'https://www.w3schools.com/html/mov_bbb.mp4' },
  ...
  { 
    ...
    level: 'Intermediate',
    materials: [
      { type: 'video', title: 'Social Media Strategy', url: 'https://www.w3schools.com/html/mov_bbb.mp4' },
  ...
  { 
    ...
    level: 'Advanced',
    materials: [
      { type: 'video', title: 'Cash Flow Management', url: 'https://www.w3schools.com/html/mov_bbb.mp4' },
          ...
          {[
            ...
            <div key={idx} className="bg-teal-800 p-8 rounded-lg border border-teal-700 hover:border-gold-500 transition-all hover:-translate-y-1 flex flex-col">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-xs bg-teal-900 px-2 py-1 rounded text-teal-200 border border-teal-600">Certified</span>
              </div>
...
const MarketplaceView: React.FC = () => {
  ...
  const products: Product[] = [
    { id: 1, name: "Banarasi Silk Saree", artisan: "Geeta Devi", price: 4500, category: "Textiles", image: "https://images.unsplash.com/photo-1610189012906-47833822b678?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
    { id: 2, name: "Hand-painted Clay Pot", artisan: "Riya Arts", price: 850, category: "Decor", image: "https://images.unsplash.com/photo-1596350338223-9c8cb5725f77?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
    { id: 3, name: "Organic Turmeric Powder", artisan: "Village SHG", price: 250, category: "Food", image: "https://images.unsplash.com/photo-1615485500704-8e99099928b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
    { id: 4, name: "Bamboo Basket Set", artisan: "Tribal Crafts", price: 1200, category: "Decor", image: "https://images.unsplash.com/photo-1597858603688-66236b281f6d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
    { id: 5, name: "Herbal Hair Oil", artisan: "Nature Pure", price: 400, category: "Beauty", image: "https://images.unsplash.com/photo-1626442674393-272e532b2a8d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
    { id: 6, name: "Embroidered Kurti", artisan: "Fashion Hub", price: 1500, category: "Textiles", image: "https://images.unsplash.com/photo-1583391733958-e04f6764493f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
  ];
    ...
    <div className="bg-stone-50 min-h-screen py-12 animate-fade-in">
      <div className="container mx-auto px-6">
        ...
        <div className="flex gap-4 overflow-x-auto pb-6 mb-8 scrollbar-hide">
          {["All", "Textiles", "Decor", "Food", "Beauty"].map(cat => (
            <button 
              key={cat}
                    ...
                    <div key={idx} className="border border-gray-200 rounded-lg p-4 hover:bg-stone-50 transition-colors">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-grow">
                           ...
                           {material.type === 'video' && (
                             <div className="mt-2 aspect-video bg-gray-900 rounded-lg flex items-center justify-center relative overflow-hidden group cursor-pointer">
                               {/* Placeholder Video */}
                               <div className="text-white text-center">
                                 <PlayCircle size={48} className="mx-auto mb-2 opacity-80 group-hover:opacity-100 transition-opacity"/>
                                 <span className="text-sm font-medium">Click to Play Video Lesson</span>
                               </div>
                             </div>
                           )}
                           {material.type === 'pdf' && (
